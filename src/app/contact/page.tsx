      ...
      <div className="flex gap-5">
        <div className="flex w-[350px] flex-col gap-4">
          <div className="rounded-[24px] bg-white p-6 shadow-sm">
            <span className="text-base font-medium text-[#9A9A9A]">Email</span>
            <p className="mt-1 text-[#202124]">support@sewago.com</p>
          </div>
          <div className="rounded-[24px] bg-white p-6 shadow-sm">
            <span className="text-base font-medium text-[#9A9A9A]">Phone</span>
            <p className="mt-1 text-[#202124]">+91 98765 43210</p>
          </div>
          <div className="rounded-[24px] bg-white p-6 shadow-sm">
            <span className="text-base font-medium text-[#9A9A9A]">Address</span>
        ...
        <div className="flex-1 rounded-[24px] bg-white p-6 shadow-sm">
          {submitted ? (
            <div className="flex flex-col items-center justify-center py-10">
              ...
              <p className="mt-2 text-base text-[#6B6B6B]">We&apos;ll get back to you soon.</p>
              <button
                onClick={() => setSubmitted(false)}
                className="mt-4 rounded-full bg-[#B8F25E] px-5 py-2 text-base font-semibold text-[#202124] "
              >
                Send Another
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div>
                <label className="mb-1 block text-base font-medium text-[#202124]">Message</label>
                <textarea
                  value={message}
                  onChange={(e) => setMessage(e.target.value)}
                  className="w-full rounded-2xl border border-gray-200 px-4 py-3 text-base outline-none focus:border-gray-300 focus:ring-1 focus:ring-gray-100"
                  rows={5}
              ...
              <button
                type="submit"
                className="w-full rounded-full bg-[#B8F25E] px-4 py-3 text-base font-semibold text-[#202124] "
              >
                Send Message
              </button>
            </form>
