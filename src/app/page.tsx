...
export default function Home() {
  ...
  return (
    <div className="flex-1" style={{ fontFamily: "var(--font-inter), Inter, sans-serif" }}>
      ...
      <div className="relative rounded-[28px] overflow-hidden h-[700px]">
        ...
        <div className="relative h-full flex flex-col justify-center px-12 max-w-[800px]">
          ...
          <div className="mt-7 flex items-center gap-3">
            <a
              href="/donate"
              className="inline-flex items-center gap-2 rounded-full bg-[#B8F25E] px-7 py-3.5 text-lg font-semibold text-[#202124] transition-colors hover:bg-[#a8e04e]"
            >
              Donate Now
      ...
      <div className="mt-16 max-w-[1400px] mx-auto px-8">
        <div className="grid grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-8 text-base text-gray-600 leading-relaxed max-w-[500px]">
            ...
            <p className="mt-4 text-base text-gray-600 leading-relaxed max-w-[500px]">
            ...
            <a
              href="/about"
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#B8F25E] px-6 py-3 text-base font-semibold text-[#202124] transition-colors hover:bg-[#a8e04e]"
            >
              About Us
            </a>
          </div>
      ...
      <div className="mt-20">
        <div className="mb-8">
          <h2 className="text-[64px] font-bold leading-[1.05] text-[#1a2e1a]">
            Choose the<br />way you want to help.
          </h2>
          <p className="mt-6 text-base text-gray-600 leading-relaxed max-w-[500px]">
        ...
        <div className="grid grid-cols-3 gap-6">
          {/* Marketplace */}
          <div className="bg-[#2196F3] rounded-[24px] px-2 pt-6 pb-2">
            <div className="pl-4">
          ...
          {/* Events */}
          <div className="bg-[#FFC107] rounded-[24px] px-2 pt-6 pb-2">
            <div className="pl-4">
              <div className="flex justify-between items-start">
          ...
          {/* Donations */}
          <div className="bg-[#4CAF50] rounded-[24px] px-2 pt-6 pb-2">
            <div className="pl-4">
              <div className="flex justify-between items-start">
          ...
          {/* Education */}
          <div className="bg-[#E91E63] rounded-[24px] px-2 pt-6 pb-2">
            <div className="pl-4">
              <div className="flex justify-between items-start">
          ...
          {/* Waste Management */}
          <div className="bg-[#1a237e] rounded-[24px] px-2 pt-6 pb-2">
            <div className="pl-4">
              <div className="flex justify-between items-start">
      ...
      <div className="mt-20">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div key={index} className="border border-gray-200 rounded-[16px] overflow-hidden">
              <button
                onClick={() => setOpenFaq(openFaq === index ? null : index)}
                className="w-full flex items-center justify-between p-6 text-left bg-white hover:bg-gray-50 transition-colors"
              >
                <span className="font-semibold text-[#1a2e1a]">{faq.question}</span>
                <ChevronDown
                  size={20}
      ...
      <div className="mt-20">
        <h2 className="text-[48px] font-bold text-[#1a2e1a] mb-4">
            ...
            <div key={item} className="relative rounded-[20px] overflow-hidden h-[250px] bg-gray-200">
              ...
              <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                <div className="w-14 h-14 bg-white/90 rounded-full flex items-center justify-center">
                  <div className="w-0 h-0 border-t-8 border-b-8 border-l-12 border-t-transparent border-b-transparent border-l-[#1a2e1a] ml-1"></div>
                </div>
              </div>
            </div>
          ))}
      ...
      <div className="mt-20 bg-[#e8f5e9] rounded-[28px] p-8 overflow-hidden">
        <div className="grid grid-cols-2 gap-8 items-center">
          <div className="relative">
            ...
            />
            <div className="absolute bottom-4 left-4 bg-white rounded-[16px] p-4 flex items-center gap-3">
          ...
          <div>
            <h2 className="text-[40px] font-bold text-[#1a2e1a]">
      ...
      <footer className="mt-16 bg-[#fef9e7] rounded-[28px] p-12 overflow-hidden">
        <div className="grid grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#1a2e1a]">Sewago</h3>
                <p className="text-xs text-gray-500">Social Service Platform</p>
              </div>
            </div>
          </div>
          <div>
            <h4 className="font-semibold text-[#1a2e1a] mb-4">Quick Links</h4>
            <ul className="space-y-2 text-gray-600">
              <li><a href="/marketplace" className="hover:text-[#1a2e1a] transition-colors">Marketplace</a></li>
              <li><a href="/events" className="hover:text-[#1a2e1a] transition-colors">Events</a></li>
              <li><a href="/about" className="hover:text-[#1a2e1a] transition-colors">About Us</a></li>
              <li><a href="/contact" className="hover:text-[#1a2e1a] transition-colors">Contact Us</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold text-[#1a2e1a] mb-4">Resources</h4>
            <ul className="space-y-2 text-gray-600">
              <li><a href="#" className="hover:text-[#1a2e1a] transition-colors">Climate Change</a></li>
              <li><a href="#" className="hover:text-[#1a2e1a] transition-colors">Sustainability</a></li>
              <li><a href="#" className="hover:text-[#1a2e1a] transition-colors">Waste Management</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 flex items-center gap-4">
          <a href="#" className="w-10 h-10 bg-[#1a2e1a] rounded-full flex items-center justify-center text-white hover:bg-gray-700 transition-colors">
