...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      {isDesktop && (
        <>
          <div className="flex fixed top-0 left-20 right-4 z-50 items-center gap-3 px-4 pt-3 pb-2 backdrop-blur-lg bg-surface/10 rounded-b-2xl" style={isDesktop ? { zoom: 0.90 } as React.CSSProperties : undefined}>
            <Logo />
            <Navbar />
          </div>
